...
//ВКМ
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.ВКМ_СуммаКОплате) Тогда
			// регистр ВКМ_ДополнительныеНачисления
			Движение = Движения.ВКМ_ДополнительныеНачисления.Добавить();
			Движение.ПериодРегистрации = НачалоМесяца(Дата);
			Движение.ВидРасчета = ПланыВидовРасчета.ВКМ_ДополнительныеНачисления.ВКМ_ПроцентОтРабот;
			Движение.ВКМ_Сотрудник = ВыборкаДетальныеЗаписи.ВКМ_Сотрудник;
...
//ВКМ
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ИначеЕсли ВыборкаДетальныеЗаписи.РезультатДопНач <> Null Тогда
			Движение.ВКМ_Сумма = (ВыборкаДетальныеЗаписи.РезультатОснНач + ВыборкаДетальныеЗаписи.РезультатДопНач) * 0.87;
		Иначе Движение.ВКМ_Сумма = ВыборкаДетальныеЗаписи.РезультатОснНач * 0.87;
		КонецЕсли;
