...
* Нажимаю на кнопку “Записать”
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		И я закрываю окно "Обслуживание клиента 00000* от *"
* В результате в форме списка документов вижу созданный документ
		И таблица  "Список" содержит строки по шаблону:
			| 'Дата' | 'Номер'  | 'Клиент'             | 'Договор'    | 'Специалист'            | 'Дата проведения работ' | 'Время начала работ (план)' | 'Время окончания работ (план)' | 'Описание проблемы'    | 'Комментарий' |
			| '*'    | '00000*' | 'ООО "Снежный барс"' | 'Договор №1' | 'Князев Роман Игоревич' | '10.10.2025'            | '12:00:00'                  | '13:00:00'                     | 'Диагностика принтера' | ''            |
...
* В результате в форме списка документов вижу созданный документ
		И таблица  "Список" содержит строки по шаблону:
			| 'Дата' | 'Номер'  | 'Клиент'        | 'Договор'    | 'Специалист'            | 'Дата проведения работ' | 'Время начала работ (план)' | 'Время окончания работ (план)' | 'Описание проблемы'   | 'Комментарий' |
			| '*'    | '00000*' | 'ООО "ИнфоТех"' | 'Договор №1' | 'Князев Роман Игоревич' | '13.10.2025'            | '14:00:00'                  | '15:00:00'                     | 'Не работает монитор' | ''            |
